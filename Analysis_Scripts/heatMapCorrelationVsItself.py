...
if __name__ == "__main__":
    ...
    popOption = input("Select population against itself? [y/n] (if n, then program does all populations against itself) ")
    if (popOption == "y"):
        ...
        try:
            ...
            majorFolder = "% Composition vs Itself Heat Map Output For Queries/"
        ...
        try:
            ...
            majorFolder = "% Composition vs Itself Heat Map Output/"
            mfiTumorFolder = majorFolder + "MFI Tables/Tumor/"
            mfiNormalFolder = majorFolder + "MFI Tables/Normal/"
            pearsonTumorFolder = majorFolder + "Pearson Tumor/"
            pearsonNormalFolder = majorFolder + "Pearson Normal/"
